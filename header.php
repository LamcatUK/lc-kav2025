...
<head>
    ...
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Satoshi-Regular.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Satoshi-Medium.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Satoshi-Bold.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/dm-serif-display-v17-latin-regular.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <?php
	...
	<nav class="navbar navbar-expand-lg">
		<div class="container gap-4">
            <div class="d-flex justify-content-between w-100 w-lg-auto align-items-center py-1 py-lg-0">
                <div class="logo-container d-flex align-items-center"><a href="/" class="logo navbar-brand" aria-label="Kunal A Vyas Homepage"></a></div>
